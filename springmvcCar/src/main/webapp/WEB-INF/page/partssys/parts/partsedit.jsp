...
<div class="content-pages-wrap">
    <div class="commonTitle">
        ...
        <form id="coursesCreat" action="partsupdate" method="post">     
		  <table border="0" cellspacing="1" cellpadding="0" class="commonTable">
			  <tr>
			    <input type="hidden" name="partsid" value=${b.partsid } />
				<td width="10%" align="right" class="title"><span class="required">*</span>配件名称：</td>
				<td width="15%" align="left"><input type="text" style="height:20px" value="${b.partsname }" name="partsname"></td>
				<td width="10%" align="right" class="title"><span class="required">*</span>规格型号：</td>
				<td width="15%" align="left"><input type="text" style="height:20px" value="${b.partsmodel }" name="partsmodel"></td>
			  </tr>
			  <tr>
				<td width="10%" align="right" class="title"><span class="required">*</span>生产厂家：</td>
				<td width="15%" align="left"><input type="text" style="height:20px" value="${b.partsloc }" name="partsloc"></td>
				<td width="10%" align="right" class="title"><span class="required">*</span>生产日期：</td>
				<td width="15%" align="left"><input type="text" style="height:20px" value="${b.partsprodate }" name="partsprodate"></td>
			  </tr>			  
			  <tr>	
