...
function showMaterials(){
	...
	//时间戳
	var url = "${pageContext.request.contextPath }/page/ordersys/order/getmater";
...
<div class="content-pages-wrap">
    <div class="commonTitle">
        ...
        <form id="coursesCreat" name="coursesCreat" action="newgetmater" method="post">
	    ...
	    <div align="left" style="margin-top:15px;margin-bottom:5px">
	    	<a href="javascript:void()" title="选择原料" class="btnShort" id="sub">选择配件</a>
	    </div>
